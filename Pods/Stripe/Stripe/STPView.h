...
@optional
- (void)stripeView:(STPView *)view withCard:(PTKCard *)card isValid:(BOOL)valid;
@end

@interface STPView : UIView <PTKViewDelegate>

- (id)initWithFrame:(CGRect)frame andKey:(NSString *)stripeKey;

@property (nonatomic) IBOutlet PTKView *paymentView;
